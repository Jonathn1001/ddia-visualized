...
**Phase 3 — Distributed core: Chapters 6, 8, 9 (4–6 weeks).** Partitioning ring → unreliable network → Raft + linearizability checker. The hardest and most valuable cluster. *(ch8 shipped 2026-07-16 — 8.1 lease/fencing playground + 8.d debrief; fig 8-4 GC-pause corruption, fencing rejection, and clock-skew corruption all engine-verified. Fencing win condition met. ch6 shipped earlier; ch9 remains.)*
